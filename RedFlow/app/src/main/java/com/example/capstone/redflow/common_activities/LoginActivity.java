...
public class LoginActivity extends AppCompatActivity {
    ...
    public  boolean isInternetAvailable(){
        ...
        final Snackbar snackBar = Snackbar.make(findViewById(R.id.activity_login), "Poor com.example.capstone.redflow.internet connection. To continue using RedFlow, please check your com.example.capstone.redflow.internet connection or turn on your wifi/data..", Snackbar.LENGTH_INDEFINITE);
