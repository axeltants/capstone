...
public class location_statistics extends DemoBase implements
    ...
    private void setData(int count, float range) {
        ...
        entries.add(new PieEntry((float) (Math.random() * mult) + mult / 5, "Cebu"));
        entries.add(new PieEntry((float) (Math.random() * mult) + mult / 5, "Bohol"));
        entries.add(new PieEntry((float) (Math.random() * mult) + mult / 5, "Dumaguete"));
        entries.add(new PieEntry((float) (Math.random() * mult) + mult / 5, "Camotes"));
        entries.add(new PieEntry((float) (Math.random() * mult) + mult / 5, "Siquijor"));
        entries.add(new PieEntry((float) (Math.random() * mult) + mult / 5, "Cagayan"));
        entries.add(new PieEntry((float) (Math.random() * mult) + mult / 5, "Manila"));
