...
public class blood_demmand_statistics extends DemoBase implements OnChartValueSelectedListener {
    ...
    private void setData(int count, float range) {
        ...
        entries.add(new PieEntry((float) (Math.random() * mult) + mult / 5, "O+"));
        entries.add(new PieEntry((float) (Math.random() * mult) + mult / 5, "O-"));
        entries.add(new PieEntry((float) (Math.random() * mult) + mult / 5, "A+"));
        entries.add(new PieEntry((float) (Math.random() * mult) + mult / 5, "A-"));
        entries.add(new PieEntry((float) (Math.random() * mult) + mult / 5, "B+"));
        entries.add(new PieEntry((float) (Math.random() * mult) + mult / 5, "B-"));
        entries.add(new PieEntry((float) (Math.random() * mult) + mult / 5, "AB+"));
        entries.add(new PieEntry((float) (Math.random() * mult) + mult / 5, "AB-"));
